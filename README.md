...
4. 서버에서 동작하기 때문에 서버 컴포넌트에서 **브라우저에서 제공하는 API는 사용할 수 없음**.


   대신에 **Node환경에서 제공해주는 NodeAPI를 사용할 수 있다.**

   예를 들어 아래와 같은 것들이 가능하다.
   ...
   - Node에서 동작하는 코드이기 때문에 Node에서 할 수 있는 것들은 다 가능하다.<br/><br/>